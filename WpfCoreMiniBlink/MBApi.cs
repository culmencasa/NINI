...
namespace MiniblinkCore
{
    internal class MBApi
    {
        ...
        public static extern IntPtr wkeGetStringW_x86(IntPtr wkeString);

        [DllImport(DLL_x64, EntryPoint = "wkeGetStringW", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetStringW_x64(IntPtr wkeString);

        public static IntPtr wkeGetStringW(IntPtr wkeString)
        {
            if (is64())
            {
                return wkeGetStringW_x64(wkeString);
            }

            return wkeGetStringW_x86(wkeString);
        }
