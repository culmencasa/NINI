...
namespace Utils.Misc.Forms
{
    public enum WindowStyles : long
    {
        ...
        /// up to the next control with the WS_GROUP style.The first control in each group usually has the WS_TABSTOP style so that 
        /// the user can move from group to group.The user can subsequently change the keyboard focus from one control in the group 
        ...
        /// </summary>
        WS_POPUPWINDOW = 0x80000000L | 0x00800000L | 0x00080000L,
        ...
        /// </summary>
        WS_TILEDWINDOW = 0x00000000L | 0x00C00000L | 0x00080000L | 0x00040000L | 0x00020000L | 0x00010000L,
        /// <summary>
