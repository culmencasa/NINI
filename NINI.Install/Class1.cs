...
namespace NINI.Install
{
    public class SchTaskExt
    {
        ...
        /// <param name="taskName"></param>
        /// <param name="executeFilePath"></param>
        /// <param name="interval"></param>
        /// <returns>state</returns>
        public static _TASK_STATE CreateTaskScheduler(string creator, string taskName, string executeFilePath, string interval,string description)
        {
            try
            {
                ...
                ITimeTrigger tt = (ITimeTrigger)task.Triggers.Create(_TASK_TRIGGER_TYPE2.TASK_TRIGGER_BOOT);
